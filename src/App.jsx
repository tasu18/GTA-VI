...
function App() {
  ...
  setTimeout(() => {
    ...
    window.location.href = "/game-setup.zip";
        ...
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <img
                ...
                alt=""
              />
              <div className="text text-white flex flex-col gap-3 absolute top-30 left-1/4 -translate-x-1/2 scale-[1.4] rotate-[-10deg]">
              ...
              <img
                className="absolute character -bottom-[60%] left-2/4 h-full -translate-x-1/2  scale-[3] rotate-[-20deg]"
                src="./girlbg.png"
                alt=""
              />
            </div>
          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%] py-10 bg-black w-full">
                ...
                <button
                  ...
                  className="bg-yellow-500 px-10 py-10 text-black mt-10 text-2xl"
                >
